...
files_to_patch = {
    "app/src/main/java/com/hordesurvival/game/engine/SpatialGrid.kt": [
        ...
        ("if (listPool.isNotEmpty()) listPool.removeAt(listPool.size - 1) else com.badlogic.gdx.utils.Array(16)", "if (listPool.size > 0) listPool.pop() else com.badlogic.gdx.utils.Array(false, 16)"),
